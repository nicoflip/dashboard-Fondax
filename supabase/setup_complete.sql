-- ========================================================
-- DASHBOARD IT FONDAX — INSTALLATION COMPLÈTE EN UN CLIC
-- Copier/coller l'intégralité de ce script dans l'éditeur SQL
-- de Supabase et cliquer sur "RUN".
-- ========================================================
...
-- ========================================================
-- 5. DONNÉES INITIALES (FONDAX SARL — Septembre 2026)
-- ========================================================
...
-- Connexions réseau (liaisons entre équipements)
DO $$
DECLARE
  id_box UUID;
  id_fw UUID;
